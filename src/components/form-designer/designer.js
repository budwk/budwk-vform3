...
import {containers, advancedFields, basicFields, systemFields, customFields} from "@/components/form-designer/widget-panel/widgetsConfig.js"
...
export function createDesigner(vueInstance) {
  ...
  return {
    ...
    getContainerByType(typeName) {
      let allWidgets = [...containers, ...basicFields, ...advancedFields,...systemFields, ...customFields]
      let foundCon = null
